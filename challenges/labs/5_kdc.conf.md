...
[realms]
 NAWOJKA.SG = {
  ...
  # have been warned.
  supported_enctypes = aes256-ct:normal aes128-cts:normal des3-hmac-sha1:normal arcfour-hmac:normal des-hmac-sha1:normal des-cbc-md5:normal des-cbc-crc:normal
 }
 ```
